<template>
  <div class="app-container">
    ...
    <el-row>
      <el-link :href="href1" type="primary" icon="el-icon-download">Download(No Name)</el-link>
      <el-link :href="href2" type="warning" icon="el-icon-download">Download(Has Name)</el-link>
    </el-row>
    <el-row>
      <el-button type="primary" @click="downloadPost">Downlaod Archive(POST)</el-button>
    </el-row>
